...
@export var sense_radius_mean:float
@export var sense_radius_std:float
@export var attraction_mean:Vector3
@export var attraction_std:float
@export var intensity_mean:float
@export var intensity_std:float
@export var aggression_mean:Vector3
@export var aggression_std:float
@export var aggression_intensity_mean:float
@export var aggression_intensity_std:float
@export var aggression_energy_threshold_mean:float
@export var aggression_energy_threshold_std:float
@export var reproduction_energy_threshold_mean:float
@export var reproduction_energy_threshold_std:float
@export var reproduction_cooldown_mean:float
@export var reproduction_cooldown_std:float
@export var brake_mean:float
@export var brake_std:float
@export var incubation_time_mean:float
